...
<style>/* Estilos generales del menú lateral */
.menu-lateral {
    height: 100%;
    width: 200px; /* Ancho del menú más pequeño */
    position: fixed;
    top: 0;
    left: -200px; /* Menú oculto inicialmente */
...
<body>
    ...
    <div id="contenido">
        ...
        <div id="menuLateral" class="menu-lateral">
            ...
            <a href="gestion_noticias.php">Inicio</a>
            <a href="crear.php">Crear Noticia</a>
            <a href="../../views/cliente/listado_categorias.php">Ver Categorias</a>
            <a href="../../include/cerrar_session.php" class="cerrar-sesion">Cerrar Sesión</a>
        </div>
    </div>
